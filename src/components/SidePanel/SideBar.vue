<template>
  <div class="p-4 mt-3 bg-timetablecell transition-colors duration-1000 rounded-md rounded-r-none shadow-md relative">
    ...
    <div
      ...
      :style="{ 'height' : `${coursePanelHeight * 0.85}px`, 'z-index' : -1 }"
    >
