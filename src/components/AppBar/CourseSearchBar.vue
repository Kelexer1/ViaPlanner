<template>
  <div class="w-3 md:w-4">
    <AutoComplete ref="searchBarComponent" @complete="populateRecommendations()" @focus="onFocus()"
      @blur="isActive = false" @option-select="courseSearched()" optionLabel="formattedName" v-model="currentQuery"
      :suggestions="allCourses" loader="pi pi-spinner" :loading="loading"
