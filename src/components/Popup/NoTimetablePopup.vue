<template>
  <div>
    <Dialog v-model:visible="visible" modal :style="{ 'max-width': '290px' }" :showHeader="false">
      ...
      <p>
        We are unable to generate timetables for one or more semesters based on your current course selection. There
        will likely be one or more conflicts in the resulting timetables.
      </p>
