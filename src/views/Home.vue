<template>
  <div class="relative">
    ...
    <div class="fixed top-0 left-0 z-30 flex flex-row h-[75px] w-full items-center justify-center md:justify-start bg-main-accent">
      <img
        src="../assets/VIA-Logo-White.png"
        class="max-w-[35px] md:max-w-[50px] my-2"
      >
      <Button
        icon="pi pi-replay"
        rounded
